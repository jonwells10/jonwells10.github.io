...
var animalsArray = ["Dog", "Elephant", "Tiger", "Fox", "Snake", "Parrot", "Bear", "Panther"];
...
function searchGif(gifName) {
    $.ajax({
            url: 'https://api.giphy.com/v1/gifs/search?q= ' + gifName + ' &api_key=49NTY3YpUAHUFDyb6dV5vRi9YtkslWHl',
            type: 'GET',
        })
